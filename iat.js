	...
	function iatExtension(options)
	{
		...
		*/
		...
		API.addStimulusSets({
			...
			touchInputStimuli: [
				{media:{html:'<div></div>'}, size:{height:48,width:30},css:{background:'#00FF00', opacity:0.3, zindex:-1, willchange: 'transform', transform: 'translateZ(0)'}, location:{right:0}, data:{handle:'right'}},
				{media:{html:'<div></div>'}, size:{height:48,width:30},css:{background:'#00FF00', opacity:0.3, zindex:-1, willchange: 'transform', transform: 'translateZ(0)'}, location:{left:0}, data:{handle:'left'}}
			]
		});
